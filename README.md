...
| Prop              | Type                                                                                                | Description                                                              | Since  |
| ----------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------ |
| **`permissions`** | <code><a href="#array">Array</a>&lt;'location' \| 'backgroundLocation' \| 'notification'&gt;</code> | Subset of permissions to request. Defaults to all supported permissions. | 8.0.43 |
